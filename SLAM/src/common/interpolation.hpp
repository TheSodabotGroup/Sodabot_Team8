...
//     assert(time <= after.utime);
    ...
    double tbStep0 = angle_diff(after.tb_angles[0], before.tb_angles[0]) * interpolateRatio;
    double tbStep1 = angle_diff(after.tb_angles[1], before.tb_angles[1]) * interpolateRatio;
    double tbStep2 = angle_diff(after.tb_angles[2], before.tb_angles[2]) * interpolateRatio;
    ...
    interpolated.tb_angles[0] = angle_sum(before.tb_angles[0], tbStep0);
    interpolated.tb_angles[1] = angle_sum(before.tb_angles[1], tbStep1);
    interpolated.tb_angles[2] = angle_sum(before.tb_angles[2], tbStep2);
