...
#include <deque>
#include <mutex>
#include <slam/mapping_3D.hpp> // @Wei
...
public:
    ...
    *
    *\================= mapping3Dmode: boolean to activate 3D mapping ===============
    */
