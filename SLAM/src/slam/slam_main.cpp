...
int main(int argc, char** argv)
{
    ...
    //======================3D==================
    const char* kMapping3DArg = "3D-mapping";
    //==========================================
    ...
    //======================3D==================
    getopt_add_bool(gopt, '\0', kMapping3DArg, 0, "Flag indicating if 3D mapping mode should be run");
    //==========================================
    ...
    //======================3D==================
    bool mapping_3D = getopt_get_bool(gopt, kMapping3DArg);
    //==========================================
