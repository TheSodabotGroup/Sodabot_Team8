...
void draw_occupancy_grid(const OccupancyGrid& grid, vx_buffer_t* buffer) // do not modify this !!
{
...
/*
stacked layers of 2d occupancy grid
*/
void draw_occupancy_grid_3D(const OccupancyGrid3D& grid, vx_buffer_t* buffer)
{
    ////////////////// TODO: Draw OccupancyGrid as specified in assignment ////////////////////////////
    for(unsigned int z = 0; z < grid.depthInCells;z++){ // accessor funcion

        image_u8_t* gridImg = image_u8_create(grid[z].widthInCells(), grid[z].heightInCells());
