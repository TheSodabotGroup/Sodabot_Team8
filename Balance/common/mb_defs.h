...
#define WHEEL_BASE              0.207  // wheel separation distance in meters
#define FWD_VEL_SENSITIVITY     0.75   // sensitivity of RC control for moving
#define TURN_VEL_SENSITIVITY    1.5   // sensitivity of RC control for turning //0.25 def
#define MAX_FWD_VEL             0.8   // maximum forwad speed (m/s)
#define MAX_TURN_VEL            2.5   // maximum turning speed (rad/s)

#define SAMPLE_RATE_HZ          100   // main filter and control loop speed 20
#define DT                      0.01  // 1/sample_rate 0.05
